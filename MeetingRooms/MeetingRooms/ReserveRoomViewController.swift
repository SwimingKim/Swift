...
class ReserveRoomViewController: UITableViewController {
    ...
    @IBAction func makeReservation(_ sender: Any) {
        ...
        case let tabBarC as UITabBarController:
            if let navigationC = tabBarC.selectedViewController as? UINavigationController,
                let reservationListVC = navigationC.topViewController as? ReservationListViewController {
